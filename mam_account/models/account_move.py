...
class AccountMove(models.Model):
    ...
    def action_submit(self):
        ...
        approvers = approvers[0] if approvers and approvers[0].status != 'to approve' else self.env['account.move.approver']
    ...
    def _account_move_post(self, soft=True):
        ...
        for invoice in to_post:
            ...
            if (
                    ...
                    and (invoice.invoice_user_id).id not in (
                ...
                invoice.activity_schedule(
                    ...
                    # here two parameters are calling the not existing field of the account_journal model.
...
class AccountMoveApprover(models.Model):
    ...
    def _compute_move_order_user_ids(self):
        for approver in self:
            approver.existing_move_user_ids = self.mapped(
                'move_id.approver_ids.user_id')._origin | self.move_id.user_id._origin
